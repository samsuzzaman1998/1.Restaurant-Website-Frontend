    ...
    return (
        <div className="flex flex-col justify-between shadow-lg hover:shadow-xl transition-all duration-200 rounded pb-4 relative group">
            ...
            <div className="flex justify-between items-center mt-4 px-4">
                ...
                <button className="text-[13px] sm:text-sm uppercase border-[1px] border-green-100 bg-green-100 inline-block py-[1px] px-4 rounded-3xl transition-all duration-200 text-white hover:bg-green-300 ">
                    add to cart
                </button>
            </div>
        </div>
